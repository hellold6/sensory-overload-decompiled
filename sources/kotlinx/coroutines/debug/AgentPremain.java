...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m1409constructorimpl = Result.m1409constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1409constructorimpl = Result.m1409constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1415isFailureimpl(m1409constructorimpl) ? null : m1409constructorimpl);
