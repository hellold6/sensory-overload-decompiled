...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2935receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2935receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2936tryReceivePtdJZtk() {
        return this._channel.mo2936tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2928trySendJP2dKIU(E e) {
        return this._channel.mo2928trySendJP2dKIU(e);
    }
