...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2995scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2916delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2917toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2917toDelayMillisLRDsOJo(long j) {
        boolean m2798isPositiveimpl = Duration.m2798isPositiveimpl(j);
        if (m2798isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m2782getInWholeMillisecondsimpl(Duration.m2800plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m2798isPositiveimpl) {
