...
public class OkHttpStreamFetcher implements DataFetcher<InputStream>, Callback {
    ...
    public void onResponse(Call call, Response response) {
        ...
        if (response.isSuccessful()) {
            InputStream obtain = ContentLengthInputStream.obtain(this.responseBody.byteStream(), ((ResponseBody) Preconditions.checkNotNull(this.responseBody)).getContentLength());
            this.stream = obtain;
