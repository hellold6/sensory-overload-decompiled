...
public final class PropsAnimatedNode extends AnimatedNode {
    ...
    public final View getConnectedView() {
        ...
        try {
            ...
            UIManager uIManager = this.connectedViewUIManager;
            m1409constructorimpl = Result.m1409constructorimpl(uIManager != null ? uIManager.resolveView(this.connectedViewTag) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1409constructorimpl = Result.m1409constructorimpl(ResultKt.createFailure(th));
        }
        return (View) (Result.m1415isFailureimpl(m1409constructorimpl) ? null : m1409constructorimpl);
    }
