...
public final class ScreenWindowTraits {
    ...
    public final void setColor$react_native_screens_release(Screen screen, Activity activity, ReactContext context) {
        ...
        UiThreadUtil.runOnUiThread(new ScreenWindowTraits$setColor$1(activity, num, (findScreenForTrait2 == null || (isStatusBarAnimated = findScreenForTrait2.getIsStatusBarAnimated()) == null) ? false : isStatusBarAnimated.booleanValue(), context.getExceptionHandler()));
    }
    ...
    public final void setTranslucent$react_native_screens_release(Screen screen, final Activity activity, ReactContext context) {
        ...
        final boolean booleanValue = (findScreenForTrait == null || (isStatusBarTranslucent = findScreenForTrait.getIsStatusBarTranslucent()) == null) ? false : isStatusBarTranslucent.booleanValue();
        final JSExceptionHandler exceptionHandler = context.getExceptionHandler();
        UiThreadUtil.runOnUiThread(new GuardedRunnable(activity, booleanValue, exceptionHandler) { // from class: com.swmansion.rnscreens.ScreenWindowTraits$setTranslucent$1
            ...
            public void runGuarded() {
                ...
                if (this.$translucent) {
                    ...
                    insetsObserverProxy.addOnApplyWindowInsetsListener(screenWindowTraits$windowInsetsListener$12);
                } else {
                    InsetsObserverProxy insetsObserverProxy2 = InsetsObserverProxy.INSTANCE;
                    screenWindowTraits$windowInsetsListener$1 = ScreenWindowTraits.windowInsetsListener;
                    insetsObserverProxy2.removeOnApplyWindowInsetsListener(screenWindowTraits$windowInsetsListener$1);
                }
    ...
    public final void setNavigationBarTranslucent$react_native_screens_release(Screen screen, Activity activity) {
        ...
        if (findScreenForTrait == null || (isNavigationBarTranslucent = findScreenForTrait.getIsNavigationBarTranslucent()) == null) {
            return;
        }
