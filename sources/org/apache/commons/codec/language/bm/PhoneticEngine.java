...
public class PhoneticEngine {
    ...
    private PhonemeBuilder applyFinalRules(PhonemeBuilder phonemeBuilder, Map<String, List<Rule>> map) {
        ...
        for (Rule.Phoneme phoneme : phonemeBuilder.getPhonemes()) {
            ...
            while (i < obj.length()) {
                ...
                RulesApplication invoke = new RulesApplication(map2, obj, phonemeBuilder2, i, this.maxPhonemes).invoke();
    ...
    public String encode(String str, Languages.LanguageSet languageSet) {
        ...
        while (i < str4.length()) {
            RulesApplication invoke = new RulesApplication(instanceMap, str4, empty, i, this.maxPhonemes).invoke();
            i = invoke.getI();
