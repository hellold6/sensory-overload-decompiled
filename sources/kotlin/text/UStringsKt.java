...
public final class UStringsKt {
    ...
    public static final String m2758toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2760toStringolVBNx4(short s, int i) {
    ...
    public static final String m2759toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m2757toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1506constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m1421boximpl(UByte.m1427constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1506constructorimpl(65535) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m1686boximpl(UShort.m1692constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m1506constructorimpl = UInt.m1506constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (i4 == 119304647) {
                    i4 = UByte$$ExternalSyntheticBackport0.m(-1, m1506constructorimpl);
            ...
            int m1506constructorimpl2 = UInt.m1506constructorimpl(i3 * m1506constructorimpl);
            int m1506constructorimpl3 = UInt.m1506constructorimpl(UInt.m1506constructorimpl(digitOf) + m1506constructorimpl2);
            compare2 = Integer.compare(m1506constructorimpl3 ^ Integer.MIN_VALUE, m1506constructorimpl2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            i3 = m1506constructorimpl3;
        }
        return UInt.m1500boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m1585constructorimpl = ULong.m1585constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UByte$$ExternalSyntheticBackport0.m$1(-1L, m1585constructorimpl);
            ...
            long m1585constructorimpl2 = ULong.m1585constructorimpl(j * m1585constructorimpl);
            long m1585constructorimpl3 = ULong.m1585constructorimpl(ULong.m1585constructorimpl(UInt.m1506constructorimpl(r13) & 4294967295L) + m1585constructorimpl2);
            compare2 = Long.compare(m1585constructorimpl3 ^ Long.MIN_VALUE, m1585constructorimpl2 ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            j = m1585constructorimpl3;
        }
        return ULong.m1579boximpl(j);
    }
}
