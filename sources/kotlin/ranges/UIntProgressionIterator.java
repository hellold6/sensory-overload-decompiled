...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m1500boximpl(m2645nextpVg5ArA());
    }
    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        ...
        L18:
            r3.hasNext = r0
            int r6 = kotlin.UInt.m1506constructorimpl(r6)
            r3.step = r6
    ...
    public int m2645nextpVg5ArA() {
        ...
        this.next = UInt.m1506constructorimpl(this.step + i);
        return i;
    }
}
