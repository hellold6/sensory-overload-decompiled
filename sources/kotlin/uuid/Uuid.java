...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m1579boximpl(ULong.m1585constructorimpl(getMostSignificantBits())), ULong.m1579boximpl(ULong.m1585constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2910toUByteArrayTcUX1vc() {
        return UByteArray.m1482constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m1585constructorimpl(j) ^ Long.MIN_VALUE, ULong.m1585constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m1585constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m1585constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2912fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2911fromUByteArrayGBYM_sE(byte[] ubyteArray) {
