...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf.Type proto, boolean z) {
        ...
        boolean z2 = true;
        if (ErrorUtils.isError(typeConstructor.mo2698getDeclarationDescriptor())) {
        ...
        if (z && (mo2698getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType computeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) mo2698getDeclarationDescriptor, list);
    ...
    */
    private final kotlin.reflect.jvm.internal.impl.types.SimpleType transformRuntimeFunctionTypeToSuspendFunction(kotlin.reflect.jvm.internal.impl.types.KotlinType r6) {
        ...
        L15:
            ...
            kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r2 = r2.mo2698getDeclarationDescriptor()
            if (r2 == 0) goto L26
