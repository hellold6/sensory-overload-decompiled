...
public final class OperatorNameConventions {
    ...
    static {
        ...
        TOKENS_BY_OPERATOR_NAME = MapsKt.mapOf(TuplesKt.to(identifier22, "++"), TuplesKt.to(identifier23, "--"), TuplesKt.to(identifier28, "+"), TuplesKt.to(identifier27, "-"), TuplesKt.to(identifier26, "!"), TuplesKt.to(identifier29, "*"), TuplesKt.to(identifier24, "+"), TuplesKt.to(identifier25, "-"), TuplesKt.to(identifier30, "/"), TuplesKt.to(identifier31, "%"), TuplesKt.to(identifier32, ".."), TuplesKt.to(identifier33, "..<"));
    }
}
