            ...
            if (z) {
                ...
                if (bool.booleanValue() && (container instanceof ProtoContainer.Package)) {
                    ...
                    if (facadeClassName != null) {
                        ...
                        return KotlinClassFinderKt.findKotlinClass(kotlinClassFinder, companion.topLevel(new FqName(StringsKt.replace$default(internalName, IOUtils.DIR_SEPARATOR_UNIX, FilenameUtils.EXTENSION_SEPARATOR, false, 4, (Object) null))), metadataVersion);
                    }
                }
            }
