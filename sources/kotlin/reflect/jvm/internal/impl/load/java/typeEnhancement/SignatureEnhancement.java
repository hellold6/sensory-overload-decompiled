...
public final class SignatureEnhancement {
    ...
    */
    ...
    public static final Boolean containsFunctionN$lambda$16(UnwrappedType unwrappedType) {
        ...
        if (Intrinsics.areEqual(mo2698getDeclarationDescriptor.getName(), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME().shortName()) && Intrinsics.areEqual(DescriptorUtilsKt.fqNameOrNull(mo2698getDeclarationDescriptor), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME())) {
            z = true;
        }
