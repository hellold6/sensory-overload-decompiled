...
public final class TypeUtilsKt {
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ...
        if (mo2698getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(mo2698getDeclarationDescriptor);
                return;
            }
            for (KotlinType kotlinType3 : ((TypeParameterDescriptor) mo2698getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNull(kotlinType3);
                extractTypeParametersFromUpperBounds(kotlinType3, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor mo2698getDeclarationDescriptor2 = kotlinType.getConstructor().mo2698getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = mo2698getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) mo2698getDeclarationDescriptor2 : null;
        ...
        for (TypeProjection typeProjection : kotlinType.getArguments()) {
            ...
            if ((typeParameterDescriptor == null || set2 == null || !set2.contains(typeParameterDescriptor)) && !typeProjection.isStarProjection() && !CollectionsKt.contains(set, typeProjection.getType().getConstructor().mo2698getDeclarationDescriptor()) && !Intrinsics.areEqual(typeProjection.getType().getConstructor(), kotlinType2.getConstructor())) {
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptor mo2698getDeclarationDescriptor = kotlinType.getConstructor().mo2698getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = mo2698getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) mo2698getDeclarationDescriptor : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
    ...
    public static final boolean containsTypeAliasParameters$lambda$13(UnwrappedType it) {
        ...
        ClassifierDescriptor mo2698getDeclarationDescriptor = it.getConstructor().mo2698getDeclarationDescriptor();
        if (mo2698getDeclarationDescriptor != null) {
            return isTypeAliasParameter(mo2698getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean requiresTypeAliasExpansion$lambda$16(UnwrappedType it) {
        ...
        ClassifierDescriptor mo2698getDeclarationDescriptor = it.getConstructor().mo2698getDeclarationDescriptor();
        if (mo2698getDeclarationDescriptor != null) {
            return (mo2698getDeclarationDescriptor instanceof TypeAliasDescriptor) || (mo2698getDeclarationDescriptor instanceof TypeParameterDescriptor);
        }
        return false;
    }
    ...
    public static final KotlinType getRepresentativeUpperBound(TypeParameterDescriptor typeParameterDescriptor) {
        ...
        while (true) {
            ...
            Object next = it.next();
            ClassifierDescriptor mo2698getDeclarationDescriptor = ((KotlinType) next).getConstructor().mo2698getDeclarationDescriptor();
    ...
    public static final KotlinType replaceArgumentsWithStarProjections(KotlinType kotlinType) {
        ...
        if (unwrap instanceof FlexibleType) {
            ...
            if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo2698getDeclarationDescriptor() != null) {
            ...
            if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo2698getDeclarationDescriptor() != null) {
            ...
            if (!simpleType2.getConstructor().getParameters().isEmpty() && simpleType2.getConstructor().mo2698getDeclarationDescriptor() != null) {
