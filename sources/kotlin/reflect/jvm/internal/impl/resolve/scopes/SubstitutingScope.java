...
public final class SubstitutingScope implements MemberScope {
    ...
    public void mo2704recordLookup(Name name, LookupLocation lookupLocation) {
    ...
    public ClassifierDescriptor mo2700getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor contributedClassifier = this.workerScope.mo2700getContributedClassifier(name, location);
