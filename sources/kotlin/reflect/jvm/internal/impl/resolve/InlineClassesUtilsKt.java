...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (mo2698getDeclarationDescriptor != null) {
            return isInlineClass(mo2698getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo2698getDeclarationDescriptor = kotlinType.getConstructor().mo2698getDeclarationDescriptor();
        if (mo2698getDeclarationDescriptor != null) {
            return isValueClass(mo2698getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo2698getDeclarationDescriptor = kotlinType.getConstructor().mo2698getDeclarationDescriptor();
        return (mo2698getDeclarationDescriptor == null || !isMultiFieldValueClass(mo2698getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
