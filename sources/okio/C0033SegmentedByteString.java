...
public final class C0033SegmentedByteString extends ByteString {
    ...
    public C0033SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C0033SegmentedByteString c0033SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0033SegmentedByteString, endIndex);
        if (beginIndex < 0) {
        ...
        if (beginIndex == 0 && resolveDefaultParameter == size()) {
            return c0033SegmentedByteString;
        }
