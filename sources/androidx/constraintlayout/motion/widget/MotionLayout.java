...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f7me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f7me.tracker = VelocityTracker.obtain();
            return f7me;
        }
    ...
    public void touchAnimateTo(int i, float f, float f2) {
        ...
        if (i == 0 || i == 1 || i == 2) {
            ...
            this.mStopLogic.config(this.mTransitionLastPosition, f3, f2, duration, this.mScene.getMaxAcceleration(), this.mScene.getMaxVelocity());
            int i2 = this.mCurrentState;
