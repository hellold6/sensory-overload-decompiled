...
public final class InitializerViewModelFactoryBuilder {
    ...
    public final <T extends ViewModel> void addInitializer(KClass<T> clazz, Function1<? super CreationExtras, ? extends T> initializer) {
        ...
        if (this.initializers.containsKey(clazz)) {
            throw new IllegalArgumentException(("A `initializer` with the same `clazz` has already been added: " + ViewModelProviders_jvmKt.getCanonicalName(clazz) + FilenameUtils.EXTENSION_SEPARATOR).toString());
        }
