...
public final class BigInt64Array implements TypedArray, GenericTypedArray<Long>, RawTypedArrayHolder {
    ...
    public /* bridge */ /* synthetic */ void set(int i, Long l) {
        set(i, l.longValue());
    }
    ...
    public Long get(int index) {
        BigInt64Array bigInt64Array = this;
        if (index >= 0 && index < bigInt64Array.getLength()) {
