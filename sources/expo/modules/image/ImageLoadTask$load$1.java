...
public final class ImageLoadTask$load$1 extends ContinuationImpl {
    int label;
    ...
    public ImageLoadTask$load$1(ImageLoadTask imageLoadTask, Continuation<? super ImageLoadTask$load$1> continuation) {
        super(continuation);
