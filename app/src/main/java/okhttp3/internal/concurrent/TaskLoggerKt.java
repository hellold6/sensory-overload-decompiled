...
public final class TaskLoggerKt {
    ...
    public static final String formatDuration(long j) {
        ...
        if (j <= -999500000) {
            ...
            str = j <= 0 ? ((j - ServiceStarter.ERROR_UNKNOWN) / 1000) + " µs" : j < 999500 ? ((j + ServiceStarter.ERROR_UNKNOWN) / 1000) + " µs" : j < 999500000 ? ((j + 500000) / 1000000) + " ms" : ((j + 500000000) / 1000000000) + " s ";
        }
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
