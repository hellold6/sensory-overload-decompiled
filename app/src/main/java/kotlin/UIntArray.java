...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m1559boximpl(int[] iArr) {
    ...
    public static boolean m1564equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).getStorage());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1565equalsimpl0(int[] iArr, int[] iArr2) {
    ...
    public static int m1568hashCodeimpl(int[] iArr) {
        return Arrays.hashCode(iArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1572toStringimpl(int[] iArr) {
    ...
    public boolean m1573addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object other) {
        return m1564equalsimpl(this.storage, other);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m1574containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    public static final int m1566getpVg5ArA(int[] iArr, int i) {
        return UInt.m1506constructorimpl(iArr[i]);
    }

    /* renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m1571setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static int m1567getSizeimpl(int[] iArr) {
        return iArr.length;
    }
    ...
    public static java.util.Iterator<UInt> m1570iteratorimpl(int[] iArr) {
    ...
    public static final class Iterator implements java.util.Iterator<UInt>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UInt next() {
            return UInt.m1500boximpl(m1576nextpVg5ArA());
        }
    ...
    public boolean m1574containsWZ4Q5Ns(int i) {
        return m1562containsWZ4Q5Ns(this.storage, i);
    }

    /* renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m1562containsWZ4Q5Ns(int[] iArr, int i) {
    ...
    public boolean containsAll(Collection<?> elements) {
        ...
        return m1563containsAllimpl(this.storage, elements);
    }

    /* renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m1563containsAllimpl(int[] iArr, Collection<UInt> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m1569isEmptyimpl(int[] iArr) {
