...
public final class LongSaturatedMathKt {
    ...
    public static final long m2876saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long m2810toLongimpl = Duration.m2810toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2875checkInfiniteSumDefinedPjuGub4(j, j2, m2810toLongimpl);
        }
        if (((m2810toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m2877saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + m2810toLongimpl;
        return ((j ^ j3) & (m2810toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m2875checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m2796isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2877saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long m2774divUwyO8pc = Duration.m2774divUwyO8pc(j2, 2);
        long m2810toLongimpl = Duration.m2810toLongimpl(m2774divUwyO8pc, durationUnit);
        return (1 | (m2810toLongimpl - 1)) == Long.MAX_VALUE ? m2810toLongimpl : m2876saturatingAddNuflL3o(m2876saturatingAddNuflL3o(j, durationUnit, m2774divUwyO8pc), durationUnit, Duration.m2799minusLRDsOJo(j2, m2774divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m2861getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m2860getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2815unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    public static final long saturatingOriginsDiff(long j, long j2, DurationUnit unit) {
        ...
        if (((j2 - 1) | 1) == Long.MAX_VALUE) {
            if (j == j2) {
                return Duration.INSTANCE.m2862getZEROUwyO8pc();
            }
            return Duration.m2815unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m2800plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m2815unaryMinusUwyO8pc(infinityOfSign(j3));
        }
