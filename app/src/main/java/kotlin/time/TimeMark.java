...
public interface TimeMark {
    ...
    TimeMark mo2762minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2764plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2885plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2884minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2764plusLRDsOJo(Duration.m2815unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2797isNegativeimpl(timeMark.mo2761elapsedNowUwyO8pc());
        }
