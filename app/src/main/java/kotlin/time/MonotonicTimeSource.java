...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2887boximpl(m2881markNowz9LOYto());
    }
    ...
    public long m2881markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2890constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2880elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2879differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2878adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2890constructorimpl(LongSaturatedMathKt.m2876saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
