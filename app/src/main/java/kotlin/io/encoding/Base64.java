    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (i7 != i4 || i6 + 3 >= endIndex) {
                ...
                i3 = 1;
                int i9 = i6 + 4;
                int i10 = (access$getBase64UrlDecodeMap$p[source[i6 + 1] & 255] << 12) | (access$getBase64UrlDecodeMap$p[source[i6] & 255] << 18) | (access$getBase64UrlDecodeMap$p[source[i6 + 2] & 255] << 6) | access$getBase64UrlDecodeMap$p[source[i6 + 3] & 255];
                if (i10 >= 0) {
            ...
            int i13 = access$getBase64UrlDecodeMap$p[i12];
            if (i13 >= 0) {
                i6++;
                i8 = (i8 << 6) | i13;
                int i14 = i7 + 6;
