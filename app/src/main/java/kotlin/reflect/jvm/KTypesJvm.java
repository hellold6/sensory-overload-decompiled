    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo2698getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo2698getDeclarationDescriptor();
                classDescriptor = mo2698getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo2698getDeclarationDescriptor : null;
