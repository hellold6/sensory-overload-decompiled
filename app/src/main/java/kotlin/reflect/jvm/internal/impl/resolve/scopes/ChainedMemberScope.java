...
public final class ChainedMemberScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2700getContributedClassifier(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.scopes) {
            ClassifierDescriptor mo2700getContributedClassifier = memberScope.mo2700getContributedClassifier(name, location);
            if (mo2700getContributedClassifier != null) {
                if (!(mo2700getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((MemberDescriptor) mo2700getContributedClassifier).isExpect()) {
                    return mo2700getContributedClassifier;
                }
                if (classifierDescriptor == null) {
                    classifierDescriptor = mo2700getContributedClassifier;
                }
            }
        }
    ...
    public void mo2704recordLookup(Name name, LookupLocation location) {
        ...
        Intrinsics.checkNotNullParameter(location, "location");
        for (MemberScope memberScope : this.scopes) {
            memberScope.mo2704recordLookup(name, location);
        }
    }
