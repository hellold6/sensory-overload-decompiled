    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo2699getSupertypes = capturedTypeConstructorImpl.mo2699getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> mo2699getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2699getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo2699getSupertypes2, 10));
            Iterator<T> it2 = mo2699getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> mo2699getSupertypes3 = intersectionTypeConstructor2.mo2699getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo2699getSupertypes3, 10));
        Iterator<T> it3 = mo2699getSupertypes3.iterator();
        while (it3.hasNext()) {
