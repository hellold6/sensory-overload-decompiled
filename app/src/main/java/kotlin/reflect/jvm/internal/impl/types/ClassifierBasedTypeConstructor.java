...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo2698getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor mo2698getDeclarationDescriptor = mo2698getDeclarationDescriptor();
        if (hasMeaningfulFqName(mo2698getDeclarationDescriptor)) {
            identityHashCode = DescriptorUtils.getFqName(mo2698getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor mo2698getDeclarationDescriptor = mo2698getDeclarationDescriptor();
        ClassifierDescriptor mo2698getDeclarationDescriptor2 = typeConstructor.mo2698getDeclarationDescriptor();
        if (mo2698getDeclarationDescriptor2 != null && hasMeaningfulFqName(mo2698getDeclarationDescriptor) && hasMeaningfulFqName(mo2698getDeclarationDescriptor2)) {
            return isSameClassifier(mo2698getDeclarationDescriptor2);
        }
        return false;
    }
