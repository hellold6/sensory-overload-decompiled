...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo2700getContributedClassifier(Name name, LookupLocation lookupLocation);
    ...
    void mo2704recordLookup(Name name, LookupLocation lookupLocation);
