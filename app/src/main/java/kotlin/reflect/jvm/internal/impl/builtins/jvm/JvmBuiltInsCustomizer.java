...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    */
    ...
    public static final Iterable getJdkMethodStatus$lambda$16(JvmBuiltInsCustomizer jvmBuiltInsCustomizer, ClassDescriptor classDescriptor) {
        ...
        while (it.hasNext()) {
            ClassifierDescriptor mo2698getDeclarationDescriptor = ((KotlinType) it.next()).getConstructor().mo2698getDeclarationDescriptor();
            LazyJavaClassDescriptor lazyJavaClassDescriptor = null;
            ClassifierDescriptor original = mo2698getDeclarationDescriptor != null ? mo2698getDeclarationDescriptor.getOriginal() : null;
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        ...
        ClassifierDescriptor mo2698getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo2698getDeclarationDescriptor();
        return Intrinsics.areEqual(mo2698getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameUnsafe(mo2698getDeclarationDescriptor) : null, DescriptorUtilsKt.getFqNameUnsafe(classDescriptor));
    }
}
