...
public final class DescriptorEquivalenceForOverrides {
    ...
    public final boolean areCallableDescriptorsEquivalent(final CallableDescriptor a2, final CallableDescriptor b, final boolean z, boolean z2, boolean z3, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (!DescriptorUtils.isLocal(callableDescriptor)) {
            ...
            OverridingUtil create = OverridingUtil.create(kotlinTypeRefiner, new KotlinTypeChecker.TypeConstructorEquality(z, a2, b) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$2
            ...
            if (create.isOverridableBy(a2, b, null, !z3).getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE && create.isOverridableBy(b, a2, null, !z3).getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE) {
                return true;
            }
        }
        return false;
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$3(boolean z, final CallableDescriptor callableDescriptor, final CallableDescriptor callableDescriptor2, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor mo2698getDeclarationDescriptor = c1.mo2698getDeclarationDescriptor();
        ClassifierDescriptor mo2698getDeclarationDescriptor2 = c2.mo2698getDeclarationDescriptor();
        if ((mo2698getDeclarationDescriptor instanceof TypeParameterDescriptor) && (mo2698getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) mo2698getDeclarationDescriptor, (TypeParameterDescriptor) mo2698getDeclarationDescriptor2, z, new Function2(callableDescriptor, callableDescriptor2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$3
