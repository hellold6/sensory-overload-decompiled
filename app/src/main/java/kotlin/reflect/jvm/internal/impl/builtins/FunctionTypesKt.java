...
public final class FunctionTypesKt {
    public static final FunctionTypeKind getFunctionTypeKind(KotlinType kotlinType) {
        ...
        if (mo2698getDeclarationDescriptor != null) {
            return getFunctionTypeKind(mo2698getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo2698getDeclarationDescriptor = kotlinType.getConstructor().mo2698getDeclarationDescriptor();
        return mo2698getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(mo2698getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo2693findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo2693findAnnotation = kotlinType.getAnnotations().mo2693findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (mo2693findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(mo2693findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo2693findAnnotation = kotlinType.getAnnotations().mo2693findAnnotation(StandardNames.FqNames.parameterName);
        if (mo2693findAnnotation == null) {
            return null;
        }
