...
public final class FunctionClassDescriptor extends AbstractClassDescriptor {
    ...
    public /* bridge */ /* synthetic */ ClassDescriptor mo2691getCompanionObjectDescriptor() {
        return (ClassDescriptor) getCompanionObjectDescriptor();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    /* renamed from: getUnsubstitutedPrimaryConstructor, reason: collision with other method in class */
    public /* bridge */ /* synthetic */ ClassConstructorDescriptor mo2692getUnsubstitutedPrimaryConstructor() {
    ...
    private final class FunctionTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public FunctionClassDescriptor mo2698getDeclarationDescriptor() {
            return FunctionClassDescriptor.this;
        }

        public String toString() {
            return mo2698getDeclarationDescriptor().toString();
        }
