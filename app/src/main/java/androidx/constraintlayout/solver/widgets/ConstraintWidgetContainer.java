...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public void layout() {
        ...
        while (z5) {
            ...
            if (!z4) {
                if (this.mListDimensionBehaviors[r16] == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT && max > 0 && getWidth() > max) {
        ...
        if (z4) {
            this.mListDimensionBehaviors[i10] = dimensionBehaviour2;
