...
public final class TrackSelectionDialogBuilder {
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        ...
        return new DialogInterface.OnClickListener() { // from class: androidx.media3.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda0
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                TrackSelectionDialogBuilder.this.m540xc121951d(trackSelectionView, dialogInterface, i);
            }
        };
    }
    ...
    public /* synthetic */ void m540xc121951d(TrackSelectionView trackSelectionView, DialogInterface dialogInterface, int i) {
