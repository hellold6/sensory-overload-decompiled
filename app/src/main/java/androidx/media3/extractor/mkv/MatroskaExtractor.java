...
public class MatroskaExtractor implements Extractor {
    ...
    */
    protected void binaryElement(int r24, int r25, androidx.media3.extractor.ExtractorInput r26) throws java.io.IOException {
        /*
    ...
    */
    private void commitSampleToOutput(androidx.media3.extractor.mkv.MatroskaExtractor.Track r20, long r21, int r23, int r24, int r25) {
        ...
        Lc4:
            r16 = r2
            androidx.media3.extractor.TrackOutput r12 = r1.output
    ...
    public static final class Track {
        ...
        /* JADX WARN: Failed to find 'out' block for switch in B:5:0x01ed. Please report as an issue. */
