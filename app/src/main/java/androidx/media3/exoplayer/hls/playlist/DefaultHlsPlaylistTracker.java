...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    public void start(Uri uri, MediaSourceEventListener.EventDispatcher eventDispatcher, HlsPlaylistTracker.PrimaryPlaylistListener primaryPlaylistListener) {
        ...
        if (this.cmcdConfiguration != null) {
            build = new CmcdData.Factory(this.cmcdConfiguration, CmcdData.STREAMING_FORMAT_HLS).setObjectType(CmcdData.OBJECT_TYPE_MANIFEST).createCmcdData().addToDataSpec(build);
        }
    ...
    public final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
            ...
            if (elapsedRealtime < this.earliestNextLoadTimeMs) {
                ...
                DefaultHlsPlaylistTracker.this.playlistRefreshHandler.postDelayed(new Runnable() { // from class: androidx.media3.exoplayer.hls.playlist.DefaultHlsPlaylistTracker$MediaPlaylistBundle$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        DefaultHlsPlaylistTracker.MediaPlaylistBundle.this.m219x7d3061bf(uri);
                    }
        ...
        public /* synthetic */ void m219x7d3061bf(Uri uri) {
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (!this.playlistSnapshot.serverControl.canBlockReload) {
                ...
                if (hlsMediaPlaylist4 == hlsMediaPlaylist2) {
                    if (hlsMediaPlaylist4.partTargetDurationUs != C.TIME_UNSET) {
                        j2 = this.playlistSnapshot.partTargetDurationUs / 2;
                    } else {
                        j2 = this.playlistSnapshot.targetDurationUs / 2;
                    }
                    j = j2;
                } else {
                    j = 0;
