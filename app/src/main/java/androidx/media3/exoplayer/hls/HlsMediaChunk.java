...
public final class HlsMediaChunk extends MediaChunk {
    ...
    public static HlsMediaChunk createInstance(HlsExtractorFactory hlsExtractorFactory, DataSource dataSource, Format format, long j, HlsMediaPlaylist hlsMediaPlaylist, HlsChunkSource.SegmentBaseHolder segmentBaseHolder, Uri uri, List<Format> list, int i, Object obj, boolean z, TimestampAdjusterProvider timestampAdjusterProvider, long j2, HlsMediaChunk hlsMediaChunk, byte[] bArr, byte[] bArr2, boolean z2, boolean z3, PlayerId playerId, CmcdData.Factory factory) {
        ...
        if (hlsMediaChunk != null) {
            ...
            boolean z8 = (dataSpec == dataSpec3 || (dataSpec != null && dataSpec3 != null && dataSpec.uri.equals(hlsMediaChunk.initDataSpec.uri) && dataSpec.position == hlsMediaChunk.initDataSpec.position)) ? z4 : false;
            uri2 = uri;
        ...
        return new HlsMediaChunk(hlsExtractorFactory, buildDataSource, dataSpec2, format, z6, dataSource2, dataSpec, z5, uri2, list, i, obj, j3, j4, segmentBaseHolder.mediaSequence, segmentBaseHolder.partIndex, !segmentBaseHolder.isPreload, i2, segmentBase.hasGapTag, z, timestampAdjusterProvider.getAdjuster(i2), j2, segmentBase.drmInitData, hlsMediaChunkExtractor, id3Decoder, parsableByteArray, z2, z3, playerId);
    }
