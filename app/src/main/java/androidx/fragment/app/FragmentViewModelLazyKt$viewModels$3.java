...
public final class FragmentViewModelLazyKt$viewModels$3 extends Lambda implements Function0<CreationExtras> {
    ...
    public final CreationExtras invoke() {
        ViewModelStoreOwner m99viewModels$lambda0;
        CreationExtras defaultViewModelCreationExtras;
        m99viewModels$lambda0 = FragmentViewModelLazyKt.m99viewModels$lambda0(this.$owner$delegate);
        HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = m99viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) m99viewModels$lambda0 : null;
