...
public class FlatBufferBuilder {
    ...
    public int offset() {
        return this.bb.capacity() - this.f8space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.bb;
            int i3 = this.f8space - 1;
            this.f8space = i3;
    ...
    public void prep(int i, int i2) {
        ...
        int i3 = ((~((this.bb.capacity() - this.f8space) + i2)) + 1) & (i - 1);
        while (this.f8space < i3 + i + i2) {
            ...
            this.f8space += this.bb.capacity() - capacity;
        }
        pad(i3);
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        ByteBuffer byteBuffer = this.bb;
        int i = this.f8space - encodedLength;
        this.f8space = i;
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.bb.capacity() - this.f8space);
        }
        this.bb.position(this.f8space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.f8space, this.bb.capacity() - this.f8space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.bb.duplicate();
        duplicate.position(this.f8space);
