...
/* compiled from: VideoPlayerSubtitles.kt */
@Metadata(d1 = {"\u0000j\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010%\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u000e\u0010 \u001a\u00020!2\u0006\u0010\"\u001a\u00020#J\u0018\u0010$\u001a\u00020!2\u0006\u0010%\u001a\u00020\u00032\u0006\u0010&\u001a\u00020'H\u0016J\u0018\u0010(\u001a\u00020!2\u0006\u0010%\u001a\u00020\u00032\u0006\u0010)\u001a\u00020*H\u0016J\u0012\u0010+\u001a\u00020!2\b\u0010,\u001a\u0004\u0018\u00010\u0015H\u0002J\n\u0010-\u001a\u0004\u0018\u00010\rH\u0002R\u001c\u0010\u0002\u001a\u0010\u0012\f\u0012\n \u0007*\u0004\u0018\u00010\u00030\u00030\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\b\u001a\u0004\u0018\u00010\u00038BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\nR&\u0010\u000b\u001a\u001a\u0012\u0004\u0012\u00020\r\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u000f\u0012\u0004\u0012\u00020\u00100\u000e0\fX\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0011\u001a\u0004\u0018\u00010\rX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0012\u001a\u0004\u0018\u00010\u0013X\u0082\u000e¢\u0006\u0002\n\u0000R(\u0010\u0016\u001a\u0004\u0018\u00010\u00152\b\u0010\u0014\u001a\u0004\u0018\u00010\u00158F@FX\u0086\u000e¢\u0006\f\u001a\u0004\b\u0017\u0010\u0018\"\u0004\b\u0019\u0010\u001aR!\u0010\u001b\u001a\u0012\u0012\u0004\u0012\u00020\u00150\u001cj\b\u0012\u0004\u0012\u00020\u0015`\u001d¢\u0006\b\n\u0000\u001a\u0004\b\u001e\u0010\u001f¨\u0006."}, d2 = {"Lexpo/modules/video/player/VideoPlayerSubtitles;", "Lexpo/modules/video/player/VideoPlayerListener;", "owner", "Lexpo/modules/video/player/VideoPlayer;", "<init>", "(Lexpo/modules/video/player/VideoPlayer;)V", "Ljava/lang/ref/WeakReference;", "kotlin.jvm.PlatformType", "videoPlayer", "getVideoPlayer", "()Lexpo/modules/video/player/VideoPlayer;", "formatsToGroups", "", "Landroidx/media3/common/Format;", "Lkotlin/Pair;", "Landroidx/media3/common/TrackGroup;", "", "currentSubtitleFormat", "currentOverride", "Landroidx/media3/common/TrackSelectionOverride;", "value", "Lexpo/modules/video/records/SubtitleTrack;", "currentSubtitleTrack", "getCurrentSubtitleTrack", "()Lexpo/modules/video/records/SubtitleTrack;", "setCurrentSubtitleTrack", "(Lexpo/modules/video/records/SubtitleTrack;)V", "availableSubtitleTracks", "Ljava/util/ArrayList;", "Lkotlin/collections/ArrayList;", "getAvailableSubtitleTracks", "()Ljava/util/ArrayList;", "setSubtitlesEnabled", "", ViewProps.ENABLED, "", "onTrackSelectionParametersChanged", "player", "trackSelectionParameters", "Landroidx/media3/common/TrackSelectionParameters;", "onTracksChanged", "tracks", "Landroidx/media3/common/Tracks;", "applySubtitleTrack", "subtitleTrack", "findSelectedSubtitleFormat", "expo-video_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class VideoPlayerSubtitles implements VideoPlayerListener {
    ...
    public final void setSubtitlesEnabled(boolean enabled) {
        ...
        TrackSelectionParameters build = trackSelectionParameters.buildUpon().setTrackTypeDisabled(3, !enabled).build();
        Intrinsics.checkNotNullExpressionValue(build, "build(...)");
        if (!enabled) {
            build = build.buildUpon().clearOverridesOfType(3).build();
            Intrinsics.checkNotNullExpressionValue(build, "build(...)");
        }
        ...
        while (it.hasNext()) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                if (MimeTypes.isText(trackFormat.sampleMimeType)) {
                    this.formatsToGroups.put(trackFormat, new Pair<>(next.getMediaTrackGroup(), Integer.valueOf(i2)));
                    SubtitleTrack fromFormat = SubtitleTrack.INSTANCE.fromFormat(trackFormat);
                    if (fromFormat != null) {
    ...
    private final void applySubtitleTrack(SubtitleTrack subtitleTrack) {
        ...
        if (this.currentOverride != null) {
            trackSelectionParameters = trackSelectionParameters.buildUpon().clearOverridesOfType(3).build();
        ...
        while (true) {
            ...
            Object next = it.next();
            if (Intrinsics.areEqual(((Format) next).id, subtitleTrack.getId())) {
                obj = next;
                break;
            }
        }
    ...
    private final Format findSelectedSubtitleFormat() {
        Format format;
        ...
        ImmutableList<String> immutableList = trackSelectionParameters != null ? trackSelectionParameters.preferredTextLanguages : null;
