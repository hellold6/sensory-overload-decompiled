...
@DebugMetadata(c = "expo.modules.medialibrary.next.objects.asset.delegates.AssetLegacyDelegate$getExif$2", f = "AssetLegacyDelegate.kt", i = {0}, l = {159}, m = "invokeSuspend", n = {"$this$withContext"}, s = {"L$0"})
/* loaded from: classes3.dex */
final class AssetLegacyDelegate$getExif$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Bundle>, Object> {
    ...
    public AssetLegacyDelegate$getExif$2(AssetLegacyDelegate assetLegacyDelegate, Continuation<? super AssetLegacyDelegate$getExif$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AssetLegacyDelegate$getExif$2 assetLegacyDelegate$getExif$2 = new AssetLegacyDelegate$getExif$2(this.this$0, continuation);
        assetLegacyDelegate$getExif$2.L$0 = obj;
        return assetLegacyDelegate$getExif$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Bundle> continuation) {
        return ((AssetLegacyDelegate$getExif$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.this$0.getSystemPermissionsDelegate().requireReadPermissions();
