...
public final class AuthenticationHelper$authenticateCipher$1 extends ContinuationImpl {
    int label;
    ...
    public AuthenticationHelper$authenticateCipher$1(AuthenticationHelper authenticationHelper, Continuation<? super AuthenticationHelper$authenticateCipher$1> continuation) {
        super(continuation);
