...
public final class Int16Array implements TypedArray, GenericTypedArray<Short>, RawTypedArrayHolder {
    ...
    public Int16Array(JavaScriptTypedArray rawArray) {
    ...
    public Short get(int index) {
        Int16Array int16Array = this;
        if (index >= 0 && index < int16Array.getLength()) {
            return Short.valueOf(read2Byte(index * 2));
        }
