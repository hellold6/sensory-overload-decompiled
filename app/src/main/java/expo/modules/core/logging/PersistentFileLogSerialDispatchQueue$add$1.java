...
public final class PersistentFileLogSerialDispatchQueue$add$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public PersistentFileLogSerialDispatchQueue$add$1(PersistentFileLogSerialDispatchQueue persistentFileLogSerialDispatchQueue, Function0<Unit> function0, Continuation<? super PersistentFileLogSerialDispatchQueue$add$1> continuation) {
