...
public final class BorderColors {
    ...
    public static final /* synthetic */ BorderColors m950boximpl(Integer[] numArr) {
        return new BorderColors(numArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static Integer[] m951constructorimpl(Integer[] edgeColors) {
        Intrinsics.checkNotNullParameter(edgeColors, "edgeColors");
        return edgeColors;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m953equalsimpl(Integer[] numArr, Object obj) {
        return (obj instanceof BorderColors) && Intrinsics.areEqual(numArr, ((BorderColors) obj).m958unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m954equalsimpl0(Integer[] numArr, Integer[] numArr2) {
        return Intrinsics.areEqual(numArr, numArr2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m955hashCodeimpl(Integer[] numArr) {
        return Arrays.hashCode(numArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m957toStringimpl(Integer[] numArr) {
        return "BorderColors(edgeColors=" + Arrays.toString(numArr) + ")";
    }

    public boolean equals(Object obj) {
        return m953equalsimpl(this.edgeColors, obj);
    }

    public int hashCode() {
        return m955hashCodeimpl(this.edgeColors);
    }

    public String toString() {
        return m957toStringimpl(this.edgeColors);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Integer[] m958unboximpl() {
    ...
    public static /* synthetic */ Integer[] m952constructorimpl$default(Integer[] numArr, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            numArr = new Integer[LogicalEdge.values().length];
        }
        return m951constructorimpl(numArr);
    }
    ...
    public static final ColorEdges m956resolveimpl(Integer[] numArr, int i, Context context) {
