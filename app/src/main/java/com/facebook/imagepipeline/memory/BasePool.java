    ...
    */
    public void release(V r6) {
        /*
            ...
            int r1 = r5.getSizeInBytes(r0)
            monitor-enter(r5)
            com.facebook.imagepipeline.memory.Bucket r2 = r5.getBucketIfPresent(r0)     // Catch: java.lang.Throwable -> Laa
            java.util.Set<V> r3 = r5.mInUseValues     // Catch: java.lang.Throwable -> Laa
            boolean r3 = r3.remove(r6)     // Catch: java.lang.Throwable -> Laa
            if (r3 != 0) goto L38
            java.lang.Class<?> r2 = r5.TAG     // Catch: java.lang.Throwable -> Laa
            ...
            com.facebook.common.logging.FLog.e(r2, r3, r0)     // Catch: java.lang.Throwable -> Laa
            r5.free(r6)     // Catch: java.lang.Throwable -> Laa
            com.facebook.imagepipeline.memory.PoolStatsTracker r6 = r5.mPoolStatsTracker     // Catch: java.lang.Throwable -> Laa
            r6.onFree(r1)     // Catch: java.lang.Throwable -> Laa
            goto La5
        L38:
            r3 = 2
            if (r2 == 0) goto L7a
            boolean r4 = r2.isMaxLengthExceeded()     // Catch: java.lang.Throwable -> Laa
            if (r4 != 0) goto L7a
            boolean r4 = r5.isMaxSizeSoftCapExceeded()     // Catch: java.lang.Throwable -> Laa
            if (r4 != 0) goto L7a
            boolean r4 = r5.isReusable(r6)     // Catch: java.lang.Throwable -> Laa
            if (r4 != 0) goto L4e
            goto L7a
        L4e:
            r2.release(r6)     // Catch: java.lang.Throwable -> Laa
            com.facebook.imagepipeline.memory.BasePool$Counter r2 = r5.mFree     // Catch: java.lang.Throwable -> Laa
            r2.increment(r1)     // Catch: java.lang.Throwable -> Laa
            com.facebook.imagepipeline.memory.BasePool$Counter r2 = r5.mUsed     // Catch: java.lang.Throwable -> Laa
            r2.decrement(r1)     // Catch: java.lang.Throwable -> Laa
            com.facebook.imagepipeline.memory.PoolStatsTracker r2 = r5.mPoolStatsTracker     // Catch: java.lang.Throwable -> Laa
            r2.onValueRelease(r1)     // Catch: java.lang.Throwable -> Laa
            boolean r1 = com.facebook.common.logging.FLog.isLoggable(r3)     // Catch: java.lang.Throwable -> Laa
            if (r1 == 0) goto La5
            java.lang.Class<?> r1 = r5.TAG     // Catch: java.lang.Throwable -> Laa
            ...
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch: java.lang.Throwable -> Laa
            com.facebook.common.logging.FLog.v(r1, r2, r6, r0)     // Catch: java.lang.Throwable -> Laa
            goto La5
        L7a:
            if (r2 == 0) goto L7f
            r2.decrementInUseCount()     // Catch: java.lang.Throwable -> Laa
        L7f:
            boolean r2 = com.facebook.common.logging.FLog.isLoggable(r3)     // Catch: java.lang.Throwable -> Laa
            if (r2 == 0) goto L98
            java.lang.Class<?> r2 = r5.TAG     // Catch: java.lang.Throwable -> Laa
            ...
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch: java.lang.Throwable -> Laa
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch: java.lang.Throwable -> Laa
            com.facebook.common.logging.FLog.v(r2, r3, r4, r0)     // Catch: java.lang.Throwable -> Laa
        L98:
            r5.free(r6)     // Catch: java.lang.Throwable -> Laa
            com.facebook.imagepipeline.memory.BasePool$Counter r6 = r5.mUsed     // Catch: java.lang.Throwable -> Laa
            r6.decrement(r1)     // Catch: java.lang.Throwable -> Laa
            com.facebook.imagepipeline.memory.PoolStatsTracker r6 = r5.mPoolStatsTracker     // Catch: java.lang.Throwable -> Laa
            r6.onFree(r1)     // Catch: java.lang.Throwable -> Laa
        La5:
            r5.logStats()     // Catch: java.lang.Throwable -> Laa
