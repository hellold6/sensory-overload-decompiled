...
public final class Comparators {
    ...
    @ParametricNullness
    public static <T> T min(@ParametricNullness T a2, @ParametricNullness T b, Comparator<? super T> comparator) {
    ...
    @ParametricNullness
    public static <T> T max(@ParametricNullness T a2, @ParametricNullness T b, Comparator<? super T> comparator) {
        return comparator.compare(a2, b) >= 0 ? a2 : b;
    }
}
