    ...
    private final int trySelectInternal(Object clauseObject, Object internalResult) {
        while (true) {
            ...
            if (obj instanceof CancellableContinuation) {
                ...
                if (Intrinsics.areEqual(obj, SelectKt.access$getSTATE_COMPLETED$p()) || (obj instanceof ClauseData)) {
                    return 3;
                }
    ...
    */
    ...
    public final class ClauseData {
        ...
        public final boolean tryRegisterAsWaiter(SelectImplementation<R> select) {
            ...
            if (DebugKt.getASSERTIONS_ENABLED() && ((SelectImplementation) select).internalResult != SelectKt.access$getNO_RESULT$p()) {
                throw new AssertionError();
            }
