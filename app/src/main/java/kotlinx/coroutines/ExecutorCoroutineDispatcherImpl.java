...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo2994dispatch(CoroutineContext context, Runnable block) {
        Runnable runnable;
        try {
            ...
            Dispatchers.getIO().mo2994dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* renamed from: scheduleResumeAfterDelay */
    public void mo2995scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        long j;
        Executor executor = getExecutor();
        ...
        if (scheduledFuture != null) {
            ...
            DefaultExecutor.INSTANCE.mo2995scheduleResumeAfterDelay(j, continuation);
        }
    }
