...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m1409constructorimpl = Result.m1409constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            m1409constructorimpl = Result.m1409constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            m1409constructorimpl = Result.m1409constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m1415isFailureimpl(m1409constructorimpl) ? null : m1409constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m1409constructorimpl = Result.m1409constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1409constructorimpl = Result.m1409constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m1415isFailureimpl(m1409constructorimpl)) {
            m1409constructorimpl = valueOf;
        }
        return ((Number) m1409constructorimpl).intValue();
    }
