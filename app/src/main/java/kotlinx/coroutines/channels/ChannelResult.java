...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m2943boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m2944constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2945equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).getHolder());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2946equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m2950hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object other) {
        return m2945equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m2950hashCodeimpl(this.holder);
    }
    ...
    public static final boolean m2953isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m2952isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* renamed from: isClosed-impl, reason: not valid java name */
    public static final boolean m2951isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl, reason: not valid java name */
    public static final T m2948getOrNullimpl(Object obj) {
    ...
    public static final T m2949getOrThrowimpl(Object obj) {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m2947exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m2958successJP2dKIU(E value) {
            return ChannelResult.m2944constructorimpl(value);
        }

        /* renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m2957failurePtdJZtk() {
            return ChannelResult.m2944constructorimpl(ChannelResult.failed);
        }

        /* renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m2956closedJP2dKIU(Throwable cause) {
            return ChannelResult.m2944constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m2954toStringimpl(this.holder);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2954toStringimpl(Object obj) {
