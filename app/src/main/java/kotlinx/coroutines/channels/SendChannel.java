...
public interface SendChannel<E> {
    ...
    Object mo2928trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2928trySendJP2dKIU = sendChannel.mo2928trySendJP2dKIU(e);
            if (ChannelResult.m2953isSuccessimpl(mo2928trySendJP2dKIU)) {
                return true;
            }
            Throwable m2947exceptionOrNullimpl = ChannelResult.m2947exceptionOrNullimpl(mo2928trySendJP2dKIU);
